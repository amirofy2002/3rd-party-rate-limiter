...
Pre-implementation. See `design/` for the architectural specification:

- `design/00-request.md` — original requirements
- `design/01-design.md` — condensed design summary
- `design/02-architecture.md` — authoritative architectural specification
- `design/tasks/STATUS.md` — implementation task tracker

## Status

Phase 1 (core local library) in progress.
